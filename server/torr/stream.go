...
func (t *Torrent) Stream(fileID int, req *http.Request, resp http.ResponseWriter) error {
	...
	// Activate episode-aware warmup and hedging for this exact file's piece range
	t.SetWarmupRange(true, file.BeginPieceIndex(), file.EndPieceIndex())
	...
	// Add support for range requests unconditionally
