...
func (r *Reader) Seek(offset int64, whence int) (n int64, err error) {
	...
	if r.file != nil && r.file.Torrent() != nil {
		r.file.Torrent().SetPlaybackPressure(true, r.file.Offset()+n)
	}
	if r.cache != nil {
		safeGo(func() {
			r.cache.refreshPriorities()
		})
	}
	return
}
...
func (r *Reader) Read(p []byte) (n int, err error) {
	...
	if r.file.Torrent() != nil && r.file.Torrent().Info() != nil {
		...
		r.file.Torrent().SetPlaybackPressure(true, r.file.Offset()+currentOffset)
	} else {
...
func (r *Reader) Close() {
	...
	if r.file != nil && r.file.Torrent() != nil && r.getUseReaders() <= 0 {
		r.file.Torrent().SetPlaybackPressure(false, -1)
	}
